/**************************************************************
* SCRIPT: BRONZE STAGE - FULL DATA LOAD (CRM & ERP Sources)
* PURPOSE: Clear and reload all core raw data tables (Full Load Pattern).
* This script assumes the database context (USE DataWarehouse;) 
